<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResetPassword.aspx.cs" Inherits="ECSSO.Account.ResetPassword" %>
...
<body>
    <form id="form1" runat="server" action="ResetPassword.aspx"
        defaultbutton="LinkButton1" submitdisabledcontrols="False">
        <asp:HiddenField ID="talken" runat="server" />
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                        ...
                        <div class="col-md-12">
                            <div class="row login" style="padding: 3px 3px;">
                                ...
                                <div class="col-md-9 col-xs-9">
                                    <asp:TextBox ID="Password" AutoCompleteType="Disabled" runat="server" TextMode="Password" Width="80%"></asp:TextBox>
                                </div>
                            </div>
                            <div class="row login" style="padding: 3px 3px;">
                                <div class="col-md-3 col-xs-3">
                                    <asp:Label ID="Label1" runat="server" Text="新密碼確認："></asp:Label>
                                </div>
                                <div class="col-md-9 col-xs-9">
                                    <asp:TextBox ID="PasswordAgain" AutoCompleteType="Disabled" runat="server" TextMode="Password" Width="80%"></asp:TextBox>
                                </div>
                            </div>
                            <div class="row login" style="padding: 3px 3px;">
                                <div class="col-md-3 col-xs-3">
                            ...
                            <div class="row login alert-danger" style="padding: 3px 3px; text-align: center;">
                                <div class="col-xs-12">
                                    <asp:Label ID="Label6" runat="server" ForeColor="Red" Text="您的密碼已逾期，請重新設定一組新的密碼!"
                            ...
                            <div class="row" style="padding: 3px 3px;">
                                <div class="col-md-12" style="text-align: center;">
                                    <asp:LinkButton ID="LinkButton1" CssClass="btn btn-danger dropdown-toggle"
                                        ...
                                        <span class="glyphicon glyphicon-ok-circle" style="font-size:large; margin-right:7px;"></span>確  認
                                    </asp:LinkButton>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row footer-memo" style="padding: 3px 3px; text-align: center;">
                        <div class="col-xs-12">
                            因應主管機關要求及確保您的帳戶安全，請每三個月變更密碼
                        </div>
                    </div>
                </div>
            </div>
